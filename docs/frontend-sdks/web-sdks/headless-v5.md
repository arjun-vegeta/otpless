...
<script
  id="otpless-sdk"
  src="https://otpless.com/v5/headless.js"
  data-appid="YOUR_APP_ID"
></script>
```

> **Important**: Make sure to add this script to the main entry point of your application (like index.html) to ensure the SDK is initialized when your domain first loads. This is crucial for proper SDK functionality across all pages.
