...
# Changelog of New iOS Headless SDK

This is the complete changelog file for the `New iOS Headless SDK.`

## 1.1.3 (2nd May 2025)

### Features

- Added support for Compose Multiplatform so that the iOS SDK can be used directly in Compose Multiplatform projects.

## 1.1.2 (28th April 2025)

### Improvements

- Bug fixes and optimizations for better performance.

## 1.1.1 (4th April 2025)
...
- Added `DELIVERY_STATUS` responseType to indicate whether authType (OTP, MAGICLINK, OTP\_LINK) has been delivered on the specified delivery channel.
