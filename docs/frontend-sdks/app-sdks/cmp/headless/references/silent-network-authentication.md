...
# Integrating Silent Network Authentication (SNA) in React Native
...
<Tabs>
  <Tab title="Android">
    - Once you have **successfully integrated OTPLESS** React Native SDK in your application, you only have to add the following line in your app's `AndroidManifest` file in the `<application>` tag:
  ...
  <Tab title="iOS">
    * Once you have **successfully integrated OTPLESS** React Native SDK in your application, you only have to add the following line in your app's `info.plist` file:
