...
<Warning>
  If you need to send the `SMS OTP` to users outside India then please reach out
  to us on [support](https://otpless.com/support) to activate it.
</Warning>

## OpenAPI

```yaml POST /v1/initiate/otp
openapi: 3.0.3
info:
...
paths:
  /v1/initiate/otp:
    post:
      ...
      description: >
        This endpoint initiates an OTP to be sent to the specified phone number
