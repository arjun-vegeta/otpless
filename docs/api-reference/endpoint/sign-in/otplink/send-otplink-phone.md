...
<Warning>
  If you need to send the `SMS OTP LINK` to users outside India then please reach out
  to us on [support](https://otpless.com/support) to activate it.
</Warning>

## OpenAPI

```yaml POST /v1/initiate/otplink
openapi: 3.0.3
info:
...
paths:
  /v1/initiate/otplink:
    post:
      ...
      description: >
        This endpoint initiates an OTP link to be sent to the specified phone
              ...
              properties:
                ...
                channels:
                  ...
                  description: >
                    ...
                    The smart authentication flow will be enabled if multiple
