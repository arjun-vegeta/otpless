...
# SendGrid Connector Documentation
...
## Connector 1-line Description

Integrate SendGrid to manage and deliver your transactional and marketing emails.

## Connector Overview

The SendGrid connector allows you to seamlessly integrate SendGrid's powerful email delivery service with your application. This connector enables you to send transactional and marketing emails reliably and at scale, leveraging SendGrid's infrastructure to ensure high deliverability rates and detailed analytics.
...
- **Reliable Infrastructure:** Leverage SendGrid's robust and secure email infrastructure.
- **Easy Integration:** Simplify the process of sending emails from your application.
...
4. **Enter API Key and Email ID:**

   - Input the API Key obtained from your SendGrid account and the From (Email ID) in the designated fields (see attached image).
...
1. **Send Test Email:**
   ...
   - Verify that the test email is received in your inbox.
